...
const PortraitGameCard = ({ game }) => {
  ...
  // Generate random discount and pricing for demo
  const discount = Math.floor(Math.random() * 80) + 20; // 20-99%
  const originalPrice = Math.floor(Math.random() * 50) + 10; // $10-$59
  const discountedPrice = Math.round((originalPrice * (100 - discount)) / 100 * 100) / 100; // Calculate discounted price
