...
export default function HomePage() {
  ...
  const handleSearch = (searchTerm) => {
    if (searchTerm.trim()) {
      // Navigate to games page with search term using React Router
        ...
        <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 text-center relative z-10">
            <div className="max-w-4xl mx-auto">
              <p className="text-blue-600 dark:text-orange-400 font-bold text-lg sm:text-xl uppercase tracking-wider mb-4 font-bold">
                Ultimate Gaming Experience
              </p>
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black mb-6 font-bold leading-none text-gray-900 dark:text-gray-100">
                Welcome to <span className="text-blue-600 dark:text-orange-400">GAMING STORE</span>
              </h1>
