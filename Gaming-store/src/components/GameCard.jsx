    ...
    <Link to={`/games/${game.id}`} className="block h-full group">
      <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 transition-all duration-200 h-full flex flex-col hover:shadow-lg dark:hover:shadow-gray-900/50">
        ...
        <div className="p-3 sm:p-4 flex flex-col flex-1">
          {/* Title - Fixed Height */}
          <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-2 line-clamp-2 transition-colors min-h-[3.5rem]">
          ...
          <div className="flex items-center justify-between mb-3 min-h-[2rem]">
            ...
            <div className="text-right">
              <span className="text-lg sm:text-xl font-bold text-blue-600 dark:text-orange-400">
                ${game.price || '29.99'}
              </span>
            </div>
          </div>
          ...
          <div className="flex gap-2 mt-auto">
            ...
            {!isInCart ? (
              ...
              <div 
                className="flex-1 flex items-center justify-center gap-2 sm:gap-3 px-3 py-3 sm:py-2 bg-blue-600 dark:bg-orange-500 hover:bg-blue-700 dark:hover:bg-orange-600 text-white rounded-lg font-medium text-sm transition-all duration-300 shadow-lg hover:shadow-xl"
              ...
              >
                ...
                <button
                  ...
                  className={`w-8 h-8 sm:w-7 sm:h-7 rounded-full flex items-center justify-center transition-all duration-200 text-white font-bold text-lg hover:scale-110 active:scale-95 touch-manipulation ${
                    quantity === 1 
                ...
                <button
                  ...
                  className="w-8 h-8 sm:w-7 sm:h-7 rounded-full bg-white/20 hover:bg-white/30 active:bg-white/40 flex items-center justify-center transition-all duration-200 text-white font-bold text-lg hover:scale-110 active:scale-95 touch-manipulation"
            ...
            <button 
              onClick={handleCartControlClick}
              className="px-3 py-3 sm:py-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg font-medium text-sm transition-colors active:scale-95 touch-manipulation"
              style={{ minHeight: '44px' }} // iOS minimum touch target
            >
              View
            </button>
