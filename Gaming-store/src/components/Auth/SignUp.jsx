        ...
        <div className="max-w-md mx-auto">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-8 border border-gray-100 dark:border-gray-700">
            ...
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2 font-bold">Create Account</h1>
              <p className="text-gray-600 dark:text-gray-300">Join the GAMING STORE community</p>
            </div>
