    ...
    <>
      ...
      {isOpen && (
        <>
          ...
          <div className={`fixed top-0 right-0 h-full w-full sm:w-96 lg:w-[450px] bg-white dark:bg-gray-800 shadow-xl z-50 transform transition-transform duration-300 ease-out ${
              ...
              {items.length > 0 && (
                <div className="border-t border-gray-200 dark:border-gray-700 p-6 bg-gray-50 dark:bg-gray-700">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <span className="text-2xl font-bold text-blue-600 dark:text-orange-400">
                  ...
                  <div className="space-y-3">
                    <button
                      ...
                      className="w-full bg-blue-600 dark:bg-orange-500 hover:bg-blue-700 dark:hover:bg-orange-600 text-white font-semibold py-3 px-6 rounded-lg transition-colors"
                    >
                      Proceed to Checkout
                    </button>
                    ...
                    <button
                      ...
                      className="w-full bg-white dark:bg-gray-800 border border-blue-500 dark:border-orange-500 text-blue-600 dark:text-orange-400 hover:bg-blue-50 dark:hover:bg-orange-900/20 font-semibold py-3 px-6 rounded-lg transition-colors"
                    >
                      View Full Cart
                    </button>
