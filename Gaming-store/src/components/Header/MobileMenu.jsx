          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-center space-x-4">
              <a
                ...
                className="p-3 text-gray-300 hover:text-pink-400 transition-colors duration-200"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 text-gray-300 hover:text-blue-400 transition-colors duration-200"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 text-gray-300 hover:text-red-400 transition-colors duration-200"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 text-gray-300 hover:text-indigo-400 transition-colors duration-200"
