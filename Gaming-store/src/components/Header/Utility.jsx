...
export default function Utility() {
  ...
  return (
    <div className="flex items-center gap-6 text-gray-700 dark:text-gray-300 relative z-10">
      ...
      {/* Cart Button */}
      <Link to="/cart">
        <button className="group relative p-3 hover:text-blue-600 dark:hover:text-orange-400 transition-all duration-300 transform hover:scale-110 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 hover:border-blue-600 dark:hover:border-orange-400 rounded-lg">
